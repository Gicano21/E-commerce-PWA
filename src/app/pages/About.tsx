        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
              "The mosquito is biting anyone that he encountered but im not talking to mosquito" - TANEO 5:05 PM
            </p><br/>
            <p>
              We only stock products that meet our strict quality standards.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
               "Customer is always right but I'm more than right!" - Nolasco 2026.
            </p><br/>
            <p>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
                "On caves, under the sea, in the sky, we are everywhere". -Aremado 2026
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
              "The sky is nonsensely blurred". -Berja 2026
            </p> <br/>
            <p>
              We're passionate about technology and sharing it with you.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
              "Respect Badings" - Ompad 2026
            </p><br />
            <p>
              We're passionate about technology and sharing kabadingan with you.
            </p>
          </div>
        </div>
      </div>
