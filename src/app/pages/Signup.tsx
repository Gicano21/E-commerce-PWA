...
export function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("https://e-commerce-server-group1.onrender.com/register", {
        method: "POST",
        headers: {
      ...
      setServerCode(data.message); // Store the server code
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        <div className="text-center">
          <div className="inline-flex items-center justify-center mb-4">
            <img src={logo} alt="Tech Store" className="h-32 w-auto rounded-[15px] shadow-xl" />
          </div>
